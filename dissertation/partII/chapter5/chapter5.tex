...
\section{Mixed Finite Element Formulation} \label{sec:chap5.mixedfem}
...
\subsection{Discretization} \label{subsec:chap5.discretization}
...
\centering
\subfloat[$\calT^p_h$]
{\includegraphics[width=\figurewidth]{partII/chapter5/figures/grid_p8}}
\subfloat[$\calT^x_h$]
{\includegraphics[width=\figurewidth]{partII/chapter5/figures/grid_x8}}
\subfloat[$\calT^y_h$]
{\includegraphics[width=\figurewidth]{partII/chapter5/figures/grid_y8}}
...
We choose test functions $\bfv^h(\bfx) = N^m_{k_m}(\bfx) \bfe_m$ ($m \in \set{1,2}$, $k_m \in I_m$) and substitute the finite element discretization \eqref{eq:chap5.staggeredapproximation.u}, \eqref{eq:chap5.staggeredapproximation.p} into each term in the mixed variational form \eqref{eq:chap5.augmented.weak}:
...
\subsection{Implementation Details} \label{subsec:chap5.implementation}
...
\begin{equation} \label{eq:chap5.stiffnessmatrix.interior}
A_u^{k_3} =
\mu
\begin{pmatrix}
...
\centering
\subfloat[]
{\includegraphics[trim=22cm 28cm 6cm 1cm,clip,width=\figurewidth]{partII/chapter5/figures/grid_esm2}}
\subfloat[]
{\includegraphics[trim=22cm 28cm 6cm 1cm,clip,width=\figurewidth]{partII/chapter5/figures/grid_esm1}}
\subfloat[]
{\includegraphics[trim=22cm 28cm 6cm 1cm,clip,width=\figurewidth]{partII/chapter5/figures/grid_esm3}}
...
The global stiffness matrix $A_u$ generated from the sum of all the element stiffness matrices $\set{A_u^{k_3}}$ at an interior degree of freedom ($x$, $y$, or $p$) has a stencil shown in Figure~\ref{fig:chap5.stiffnessmatrix.global}.

\setlength{\figurewidth}{\textwidth}
\begin{figure}[htbp]
\centering
\includegraphics[width=\figurewidth]{partII/chapter5/figures/A_stencil_latex}
...
\centering
\subfloat[]
{\includegraphics[trim=160mm 162mm 0mm 0mm,clip,width=\figurewidth]{partII/chapter5/figures/grid_zoomin8}}
\subfloat[]
{\includegraphics[trim=160mm 162mm 0mm 0mm,clip,width=\figurewidth]{partII/chapter5/figures/grid_bdrycurve8}}
...
\begin{figure}[htb]
\centering
\subfloat[An example boundary band of pressure cells and boundary variables using $3 \times 3$ blocks of cells centered at each cell that intersects the boundary.]
{\includegraphics[width=\figurewidth]{partII/chapter5/figures/grid_bdryband_new}}
\subfloat[An example of distributive pressure cells and variables relaxed using distributive relaxation. This example region is defined by excluding $1 \times 1$ blocks of cells (i.e., a single cell) centered at each cell intersecting the boundary.]
{\includegraphics[width=\figurewidth]{partII/chapter5/figures/grid_dist_final}}
...
For a staggered finite difference discretization, the triangularization of the discretized system can be effected by discretizing the transformation operator $\tilde{\bfM}$ in \eqref{eq:chap5.distributive.transform} using centered
...
\subsubsection{High order defect correction} \label{subsubsec:chap5.multigrid.relaxation.defectcorrection}
...
One of the benefits we obtain from such an approximation is that we can use the distributive relaxation described above with an exact triangulation of the discretized system \eqref{eq:chap5.distributive.triangularized}. To be specific, let us write the finite difference system as
\begin{equation*}
...
In the case of Dirichlet boundary conditions, the system \eqref{eq:chap5.kkt.unaugmented} is strongly indefinite and cannot be relaxed using, e.g., Gauss-Seidel. Alternative approaches such as Kaczmarz relaxation or box relaxation may be efficient smoothers; however, they have a high computational cost. Instead, we utilize the fundamental basis of the constraint matrix to solve $\vec{v}$ in the $Z^tAZ$ system \eqref{eq:chap5.ztaz} and then reconstruct $\vec{u}$ in \eqref{eq:chap5.kkt.unaugmented} via $\vec{u} := \vec{c} + Z \vec{v}$. Since $Z^tAZ$ is symmetric positive definite (see Chapter~\ref{chap:partII.poisson}, \S\ref{subsubsec:chap4.nullspacemethod}), one may confidently apply Gauss-Seidel relaxation; see Algorithm~\ref{alg:chap5.relaxation.boundary.dirichlet.v} and compare Chapter~\ref{chap:partII.poisson}, \S\ref{subsec:chap4.multigrid.smoothing}.
...
\subsection{Coarsening} \label{subsec:chap5.multigrid.coarsening}
...
\centering
\subfloat[Undeformed.]
{\includegraphics[trim=4cm 1cm 4cm 1cm,clip,width=\figurewidth]{partII/chapter5/figures/ginkgo}}
\subfloat[Deformed.]
{\includegraphics[trim=4cm 1cm 4cm 1cm,clip,width=\figurewidth]{partII/chapter5/figures/ginkgo_deformed}}
...
\centering
\subfloat[Undeformed.]
{\includegraphics[trim=4cm 1cm 4cm 1cm,clip,width=\figurewidth]{partII/chapter5/figures/flower}}
\subfloat[Deformed.]
{\includegraphics[trim=4cm 1cm 4cm 1cm,clip,width=\figurewidth]{partII/chapter5/figures/flower_deformed}}
...
\centering
\subfloat[Undeformed.]
{\includegraphics[trim=4cm 1cm 4cm 1cm,clip,width=\figurewidth]{partII/chapter5/figures/spiral}}
\subfloat[Deformed.]
{\includegraphics[trim=4cm 1cm 4cm 1cm,clip,width=\figurewidth]{partII/chapter5/figures/spiral_deformed}}
\caption{Spiral domain.}
\end{figure}

\end{enumerate}

\subsection{Convergence} \label{subsec:chap5.examples.convergence}
...
\begin{figure}[htbp]
\centering
\subfloat[Neumann BCs; $\nu = 0.3$]
{\includegraphics[width=\figurewidth]{partII/chapter5/figures/ginkgo_squeeze_pr3_neu}}
\subfloat[Neumann BCs; $\nu = 0.49$]
{\includegraphics[width=\figurewidth]{partII/chapter5/figures/ginkgo_squeeze_pr49_neu}} \\
\subfloat[Dirichlet BCs; $\nu = 0.3$]
{\includegraphics[width=\figurewidth]{partII/chapter5/figures/ginkgo_squeeze_pr3_noth}}
\subfloat[Dirichlet BCs; $\nu = 0.49$]
{\includegraphics[width=\figurewidth]{partII/chapter5/figures/ginkgo_squeeze_pr49_noth_hiprol}}
...
\centering
\subfloat[Neumann BCs; $\nu = 0.3$]
{\includegraphics[width=\figurewidth]{partII/chapter5/figures/egg_flower_pr3_neu}}
\subfloat[Neumann BCs; $\nu = 0.49$]
{\includegraphics[width=\figurewidth]{partII/chapter5/figures/egg_flower_pr49_neu}} \\
\subfloat[Dirichlet BCs; $\nu = 0.3$]
{\includegraphics[width=\figurewidth]{partII/chapter5/figures/egg_flower_pr3_noth}}
\subfloat[Dirichlet BCs; $\nu = 0.49$]
{\includegraphics[width=\figurewidth]{partII/chapter5/figures/egg_flower_pr49_noth_hiprol}}
...
\centering
\subfloat[Neumann BCs; $\nu = 0.3$]
{\includegraphics[width=\figurewidth]{partII/chapter5/figures/fan_spiral_pr3_neu}}
\subfloat[Neumann BCs; $\nu = 0.49$]
{\includegraphics[width=\figurewidth]{partII/chapter5/figures/fan_spiral_pr49_neu}} \\
\subfloat[Dirichlet BCs; $\nu = 0.3$]
{\includegraphics[width=\figurewidth]{partII/chapter5/figures/fan_spiral_pr3_noth}}
\subfloat[Dirichlet BCs; $\nu = 0.49$]
{\includegraphics[width=\figurewidth]{partII/chapter5/figures/fan_spiral_pr49_noth_hiprol}}
...
\subsection{Multigrid} \label{subsec:chap5.examples.multigrid}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\figurewidth]{partII/chapter5/figures/Periodic_Square_Regular__FED_Vcycle_PLo_bw42_pr0_49_br10_residual}
...
\centering
\subfloat[Dirichlet BCs]
{\includegraphics[width=\figurewidth]{partII/chapter5/figures/Egg_Flower_Dirichlet_NothG_FED_Vcycle_PLo_bw42_pr0_49_br10}}
\subfloat[Neumann BCs]
{\includegraphics[width=\figurewidth]{partII/chapter5/figures/Egg_Flower_Neumann_FED_Vcycle_PLo_bw42_pr0_49_br10}}
...
\centering
\subfloat[Dirichlet BCs]
{\includegraphics[width=\figurewidth]{partII/chapter5/figures/Egg_Flower_A38_Dirichlet_NothG_FED_Vcycle_PLo_bw32_pr0_49_br10_residual}}
\subfloat[Neumann BCs]
{\includegraphics[width=\figurewidth]{partII/chapter5/figures/Egg_Flower_A38_Neumann_FED_Vcycle_PLo_bw32_pr0_49_br10_residual}}
