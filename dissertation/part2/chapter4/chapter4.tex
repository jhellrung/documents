...
{\includegraphics[width=\figurewidthii]{part2/chapter4/figures/4tri_square_a}}
\subfloat[The division of each triangle according to the level set function values at its vertices.]
{\includegraphics[width=\figurewidthii]{part2/chapter4/figures/4tri_square_b}}
...
{\includegraphics[width=\figurewidthii]{part2/chapter4/figures/4tri_square_c}}
...
\begin{figure}[htb]
\centering
\includegraphics[width=\figurewidth]{part2/chapter4/figures/poisson_stencil_2d}
...
{\includegraphics[width=\figurewidth]{part2/chapter4/figures/lambda_h_1}}
\subfloat[Schematic of functions in $\Lambda^h_2$, with double-wide constraints $C_2$]
{\includegraphics[width=\figurewidth]{part2/chapter4/figures/lambda_h_2}}
...
{\includegraphics[width=\figurewidth]{part2/chapter4/figures/aggregation_graph}}
...
{\includegraphics[width=\figurewidth]{part2/chapter4/figures/aggregation_independent}} \\
...
{\includegraphics[width=\figurewidth]{part2/chapter4/figures/aggregation_constraints_a}}
...
{\includegraphics[width=\figurewidth]{part2/chapter4/figures/aggregation_constraints_b}}
...
\begin{figure}[htb]
\centering
\includegraphics[width=\figurewidth]{part2/chapter4/figures/independent_dof_selection_termination}
...
{\includegraphics[width=\figurewidth]{part2/chapter4/figures/dof_enumeration_for_T_a}}
\subfloat[Exterior discretization]
{\includegraphics[width=\figurewidth]{part2/chapter4/figures/dof_enumeration_for_T_b}}
...
{\includegraphics[width=\figurewidth]{part2/chapter4/figures/boundary_interface_distance_a}}
\subfloat[$\Omega^+$ discretization]
{\includegraphics[width=\figurewidth]{part2/chapter4/figures/boundary_interface_distance_b}}
...
{\includegraphics[width=\figurewidthii]{part2/chapter4/figures/examples/example4a_convergence}}
\subfloat[$(\alpha^-, \alpha^+) = (10,1)$; estimated orders of $1.798$ for $u$, $0.926$ for $\nabla u$]
{\includegraphics[width=\figurewidthii]{part2/chapter4/figures/examples/example4b_convergence}}
\subfloat[$(\alpha^-, \alpha^+) = (100,1)$; estimated orders of $1.824$ for $u$, $0.923$ for $\nabla u$]
{\includegraphics[width=\figurewidthii]{part2/chapter4/figures/examples/example4c_convergence}} \\
\subfloat[$(\alpha^-, \alpha^+) = (1,2)$; estimated orders of $1.919$ for $u$, $1.014$ for $\nabla u$]
{\includegraphics[width=\figurewidthii]{part2/chapter4/figures/examples/example4d_convergence}}
\subfloat[$(\alpha^-, \alpha^+) = (1,10)$; estimated orders of $1.932$ for $u$, $1.012$ for $\nabla u$]
{\includegraphics[width=\figurewidthii]{part2/chapter4/figures/examples/example4e_convergence}}
\subfloat[$(\alpha^-, \alpha^+) = (1,100)$; estimated orders of $1.938$ for $u$, $1.023$ for $\nabla u$]
{\includegraphics[width=\figurewidthii]{part2/chapter4/figures/examples/example4f_convergence}}
...
\begin{figure}[htbp]
\centering
\subfloat[Example~\ref{subsec:ch4.examples.neumann.1}]
{\includegraphics[width=\figurewidth]{part2/chapter4/figures/examples/multigrid/example1_1_convergence}}
\subfloat[Example~\ref{subsec:ch4.examples.neumann.2}]
{\includegraphics[width=\figurewidth]{part2/chapter4/figures/examples/multigrid/example2_1_convergence}}
...
\centering
\subfloat[$\text{BSRW} = 2$]
{\includegraphics[width=\figurewidth]{part2/chapter4/figures/examples/multigrid/example3_2_convergence}}
\subfloat[$\text{BSRW} = 3$]
{\includegraphics[width=\figurewidth]{part2/chapter4/figures/examples/multigrid/example3_3_convergence}}
...
{\includegraphics[width=\figurewidth]{part2/chapter4/figures/examples/multigrid/example4a_2_convergence}}
\subfloat[$(\alpha^-, \alpha^+) = (2,1)$, $\text{ISRW} = 3$]
{\includegraphics[width=\figurewidth]{part2/chapter4/figures/examples/multigrid/example4a_3_convergence}}
\subfloat[$(\alpha^-, \alpha^+) = (10,1)$, $\text{ISRW} = 2$]
{\includegraphics[width=\figurewidth]{part2/chapter4/figures/examples/multigrid/example4b_2_convergence}} \\
\subfloat[$(\alpha^-, \alpha^+) = (10,1)$, $\text{ISRW} = 3$]
{\includegraphics[width=\figurewidth]{part2/chapter4/figures/examples/multigrid/example4b_3_convergence}}
\subfloat[$(\alpha^-, \alpha^+) = (1,2)$, $\text{ISRW} = 2$]
{\includegraphics[width=\figurewidth]{part2/chapter4/figures/examples/multigrid/example4d_2_convergence}}
\subfloat[$(\alpha^-, \alpha^+) = (1,2)$, $\text{ISRW} = 3$]
{\includegraphics[width=\figurewidth]{part2/chapter4/figures/examples/multigrid/example4d_3_convergence}} \\
\subfloat[$(\alpha^-, \alpha^+) = (1,10)$, $\text{ISRW} = 2$]
{\includegraphics[width=\figurewidth]{part2/chapter4/figures/examples/multigrid/example4e_2_convergence}}
\subfloat[$(\alpha^-, \alpha^+) = (1,10)$, $\text{ISRW} = 3$]
{\includegraphics[width=\figurewidth]{part2/chapter4/figures/examples/multigrid/example4e_3_convergence}}
