...
{\includegraphics[width=\figurewidth]{part2/chapter5/figures/bw/grid_bdryband_new.png}}
...
{\includegraphics[width=\figurewidth]{part2/chapter5/figures/bw/grid_dist_final.png}}
...
\end{align*}
and then applying the correction $\vec{v} \leftarrow \vec{v} + \delta \vec{e}_i$. Equivalently, one may update the $\vec{u}$ degrees of freedom directly: $\vec{u} \leftarrow \vec{u} + \delta Z \vec{e}_i$; see Algorithm~\ref{alg:ch5.relaxation.boundary.dirichlet.u}.

\begin{algorithm}[htbp]
\caption{Boundary relaxation with Dirichlet boundary conditions - $\vec{u}$.}
\label{alg:ch5.relaxation.boundary.dirichlet.u}
\begin{algorithmic}[1]
...
\centering
\subfloat[Undeformed.]
{\includegraphics[trim=4cm 1cm 4cm 1cm,clip,width=\figurewidth]{part2/chapter5/figures/bw/ginkgo}}
\subfloat[Deformed.]
{\includegraphics[trim=4cm 1cm 4cm 1cm,clip,width=\figurewidth]{part2/chapter5/figures/bw/ginkgo_deformed}}
...
\centering
\subfloat[Undeformed.]
{\includegraphics[trim=4cm 1cm 4cm 1cm,clip,width=\figurewidth]{part2/chapter5/figures/bw/flower}}
\subfloat[Deformed.]
{\includegraphics[trim=4cm 1cm 4cm 1cm,clip,width=\figurewidth]{part2/chapter5/figures/bw/flower_deformed}}
...
\centering
\subfloat[Undeformed.]
{\includegraphics[trim=4cm 1cm 4cm 1cm,clip,width=\figurewidth]{part2/chapter5/figures/bw/spiral}}
\subfloat[Deformed.]
{\includegraphics[trim=4cm 1cm 4cm 1cm,clip,width=\figurewidth]{part2/chapter5/figures/bw/spiral_deformed}}
...
{\includegraphics[width=\figurewidth]{part2/chapter5/figures/bw/ginkgo_squeeze_pr3_neu}}
\subfloat[Neumann BCs; $\nu = 0.49$]
{\includegraphics[width=\figurewidth]{part2/chapter5/figures/bw/ginkgo_squeeze_pr49_neu}} \\
\subfloat[Dirichlet BCs; $\nu = 0.3$]
{\includegraphics[width=\figurewidth]{part2/chapter5/figures/bw/ginkgo_squeeze_pr3_noth}}
\subfloat[Dirichlet BCs; $\nu = 0.49$]
{\includegraphics[width=\figurewidth]{part2/chapter5/figures/bw/ginkgo_squeeze_pr49_noth_hiprol}}
...
\centering
\subfloat[Neumann BCs; $\nu = 0.3$]
{\includegraphics[width=\figurewidth]{part2/chapter5/figures/bw/egg_flower_pr3_neu}}
\subfloat[Neumann BCs; $\nu = 0.49$]
{\includegraphics[width=\figurewidth]{part2/chapter5/figures/bw/egg_flower_pr49_neu}} \\
\subfloat[Dirichlet BCs; $\nu = 0.3$]
{\includegraphics[width=\figurewidth]{part2/chapter5/figures/bw/egg_flower_pr3_noth}}
\subfloat[Dirichlet BCs; $\nu = 0.49$]
{\includegraphics[width=\figurewidth]{part2/chapter5/figures/bw/egg_flower_pr49_noth_hiprol}}
...
\centering
\subfloat[Neumann BCs; $\nu = 0.3$]
{\includegraphics[width=\figurewidth]{part2/chapter5/figures/bw/fan_spiral_pr3_neu}}
\subfloat[Neumann BCs; $\nu = 0.49$]
{\includegraphics[width=\figurewidth]{part2/chapter5/figures/bw/fan_spiral_pr49_neu}} \\
\subfloat[Dirichlet BCs; $\nu = 0.3$]
{\includegraphics[width=\figurewidth]{part2/chapter5/figures/bw/fan_spiral_pr3_noth}}
\subfloat[Dirichlet BCs; $\nu = 0.49$]
{\includegraphics[width=\figurewidth]{part2/chapter5/figures/bw/fan_spiral_pr49_noth_hiprol}}
