...
\newlength\figheightptiiembedding
\setlength\figheightptiiembedding{0.40\columnwidth}
\begin{figure}[htbp]
\begin{center}
\subfigure[Embedding in $2$ dimensions]
{\includegraphics[height=\figheightptiiembedding]{part2/figures/embedding_2d}}
\subfigure[Embedding in $3$ dimensions]
{\includegraphics[height=\figheightptiiembedding]{part2/figures/embedding_3d}}
